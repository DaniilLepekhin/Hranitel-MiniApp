...
async def main():
    ...
    print("=" * 60)
    print("🔄 Синхронизация городов v5 (последовательная)")
    ...
    try:
        ...
        """)
        users = cur.fetchall()
        print(f"👥 Пользователей: {len(users)}", flush=True)
        print("-" * 60, flush=True)
