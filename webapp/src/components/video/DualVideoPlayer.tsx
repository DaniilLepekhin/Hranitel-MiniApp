  ...
  if (!selectedSource) {
    return (
      <div className="w-full">
        ...
        {pdfUrl && (
          <button
            onClick={() => router.push(getPdfViewerUrl(pdfUrl, 'Презентация'))}
            className="mt-4 w-full flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-[#d93547]/10 text-[#d93547] font-semibold hover:bg-[#d93547]/20 transition-all active:scale-[0.98]"
          >
