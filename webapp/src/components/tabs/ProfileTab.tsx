      ...
      <ConfirmModal
        ...
        message={
          user?.cloudpaymentsSubscriptionId
            ? 'Вы уверены, что хотите отменить подписку? Автопродление будет отключено, доступ сохранится до конца оплаченного периода.'
            : 'Вы уверены, что хотите отменить подписку? После отмены автопродление будет отключено.'
        }
