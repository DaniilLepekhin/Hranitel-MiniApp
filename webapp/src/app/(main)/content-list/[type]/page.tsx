    ...
    <div className="px-4 pt-6 pb-24">
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <div className="flex-1">
          <h1 className="text-xl font-bold text-[#3d2f1f]">{config.title}</h1>
          <p className="text-sm text-[#6b5a4a]">{config.description}</p>
        </div>
      </div>

      {/* Hero Card */}
      <Card className={`p-6 mb-6 bg-gradient-to-br ${config.gradient}/20 border-2 border-[#8b0000]`}>
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1">
            <h2 className="text-xl font-bold text-[#3d2f1f] mb-1">{config.title}</h2>
      ...
      {keys.length > 0 && (
        <div className="mb-6">
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="text-sm font-semibold text-[#3d2f1f]">Фильтр по ключам</span>
          </div>
      ...
      {items.length === 0 ? (
        <Card className="p-8 text-center">
          <Icon className="w-16 h-16 mx-auto text-[#8b4513]/50 mb-4" />
