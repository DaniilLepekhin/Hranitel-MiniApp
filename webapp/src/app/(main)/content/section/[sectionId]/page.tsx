    ...
    return (
      <div className="px-4 pt-6 pb-24">
        ...
        <div className="text-center py-12">
          <Play className="w-16 h-16 mx-auto text-[#9c1723]/50 mb-4" />
          <h3 className="text-lg font-semibold text-[#2b2520] mb-2">Видео не найдены</h3>
    ...
    <div className="px-4 pt-6 pb-24">
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <div className="flex-1">
          <h1 className="text-xl font-bold text-[#2b2520]">Видео урока</h1>
      ...
      <Card className="p-4 mb-6 bg-gradient-to-br from-[#d93547]/10 to-[#9c1723]/10">
        <div className="flex items-center justify-between">
          ...
          <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-[#d93547] to-[#9c1723] flex items-center justify-center shadow-lg">
        ...
        <div className="mt-4 h-2 bg-[#e8dcc6] rounded-full overflow-hidden">
          <div
            className="h-full bg-gradient-to-r from-[#d93547] to-[#9c1723] transition-all duration-500"
            style={{
              ...
              <div className="flex gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-start justify-between gap-2 mb-1">
                    <h3 className="font-semibold text-[#2b2520] line-clamp-2 flex-1">
                      {video.title}
                    </h3>
                    {isWatched && (
                      <CheckCircle className="w-5 h-5 text-[#d93547] flex-shrink-0" />
                    )}
                  </div>
                  ...
                  <div className="flex items-center gap-3 text-xs">
                    {video.durationSeconds && (
                      <span className="text-[#d93547] font-semibold">
                        {Math.floor(video.durationSeconds / 60)} мин
                      </span>
                    )}
                    {videoProgress && videoProgress.energiesEarned > 0 && (
                      <span className="px-2 py-1 rounded-full bg-[#d93547]/10 text-[#d93547] font-semibold">
