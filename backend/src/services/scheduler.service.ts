...
export interface ScheduledTask {
  ...
  type:
    ...
    | 'women_burning_topics'  // Горящие темы (выбор проблемы) через 5 мин (1 мин для теста) после истории успеха
    | 'women_final_reminder'  // Финальное напоминание о закрытии через 4 часа (1 мин для теста) после горящих тем
