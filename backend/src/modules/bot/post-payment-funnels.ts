...
export async function sendMenuMessage(chatId: number) {
  ...
  await getTelegramService().sendMessage(
    chatId,
    `ЭТО МЕНЮ УЧАСТНИКА КЛУБА КОД УСПЕХА ❤️

Добро пожаловать, мы рады тебе!

<b>Переходи в канал клуба</b>, там тебя ждет вся информация о марафоне «Упакуй блог и запусти продажи за 72 часа» 😍

Старт уже начался — включайся и делай вместе с нами 🚀`,
