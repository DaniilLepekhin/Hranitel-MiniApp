  ...
  try {
    ...
    if (startPayload === 'test_start_full') {
      ...
      await telegramService.sendMessage(
        ...
        `Это пространство для тех, кто хочет <b>деньги, масштаб и проявленность, но больше не готов выгорать</b> ради результата.\n\n` +
        `Здесь не гонка ❌\n` +
        `Здесь <b>путь.</b>\n\n` +
        `Сначала — <b>состояние и база.</b>\n` +
        `Потом — <b>деньги и рост.</b>\n\n` +
        `<b>Что ты получаешь 👇</b>\n` +
        `— <b>личную дорожную карту</b> из <b>точки А в точку Б</b>\n` +
        `с понятными шагами\n` +
