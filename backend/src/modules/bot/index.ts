...
async function processScheduledTask(task: ScheduledTask): Promise<void> {
  ...
  try {
    ...
    if (type === 'start_reminder') {
      ...
      await telegramService.sendPhoto(
        ...
        'https://t.me/mate_bot_open/9681',
        {
          caption:
            ...
            `👉🏼 1 месяц = 2000 ₽\n` +
            `👉🏼 В подписку входит полный доступ к клубу «Код Успеха»: обучение и мини-курсы по мягким нишам, десятки — мини-группы поддержки, чаты и офлайн-встречи по городам, закрытые эфиры и разборы с Кристиной, подкасты, баллы и приложение\n` +
      ...
      // 🆕 Марафон КОД ДЕНЕГ через 5 минут после билета
