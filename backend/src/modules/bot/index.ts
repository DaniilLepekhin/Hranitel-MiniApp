  ...
  try {
    ...
    if (type === 'start_reminder') {
      ...
      await telegramService.sendMessage(
        chatId,
        `<b>Это не просто клуб.</b>\n` +
        `<b>Это точка, где меняется траектория дохода.</b>\n\n` +
        ...
        `<b>Живые встречи в твоём городе и за его пределами — у нас 60+ чатов по городам и странам.</b> Девушки встречаются, пьют чай, обнимаются, делятся самым важным. Настоящая реальная связь.\n\n` +
      ...
      // Day 2 - 10:00 Moscow time
      await telegramService.sendVideo(
        chatId,
        'https://t.me/mate_bot_open/9279',
        {
          caption:
            `Не всем нужен шум.\n` +
      ...
      // Day 3 - 11:00 Moscow time
      await telegramService.sendVideo(
        chatId,
        'https://t.me/mate_bot_open/9280',
        {
          caption:
      ...
      // Day 4 - 11:00 Moscow time
      await telegramService.sendVideo(
        chatId,
        'https://t.me/mate_bot_open/9281',
        {
          caption:
      ...
      // Day 5 - 11:00 Moscow time - Final reminder with image
      await telegramService.sendPhoto(
        chatId,
        'https://t.me/mate_bot_open/9282',
        {
          caption:
            `<b>Не сейчас.\n` +
            `Не сейчас.\n` +
