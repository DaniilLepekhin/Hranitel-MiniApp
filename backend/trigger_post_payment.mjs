...
const DATABASE_URL = 'postgresql://postgres:kH*kyrS&9z7K@31.128.36.81:5423/club_hranitel';
...
async function main() {
  ...
  try {
    ...
    // Send first message via bot
    const bot = new Bot(TELEGRAM_BOT_TOKEN);
    const chatId = parseInt(TARGET_TG_ID);

    console.log(`📤 Sending first message to chat ${chatId}...`);
